    ...
    <div>
      <section id="about" class="about section">
        ...
        <div class="container">
          <div class="row">
            <div
              class="col-lg-12 content container section-title aos-init aos-animate"
              data-aos="fade-up"
              data-aos-delay="100"
            >
              <p>
              ...
              <ul class="section-title p-5">
                <li>
                  <Zap />
                  <span>
                    We value quality, craftsmanship, and disciplined
                ...
                <li>
                  <Zap />
                  <span>
                    Our project teams are meticulously tailored to meet the
                ...
                <li>
                  <Zap />
                  <span>
                    Collaborative teamwork is at the heart of our approach to
                    generating exceptional project results.
                  </span>
                </li>
              </ul>
            </div>
